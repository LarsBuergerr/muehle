...
class ControllerSpec extends AnyWordSpec {
    ...
    var field = new Field(Player(9, 9), 0 , None, 2, 3, new MuehlMatrix[Option[Piece]](3, None))
    ...
    "A Controller" should {
        ...
        "be able to undo and redo a move and notifiying the Observers" in {
            ...
            controller.undo
            controller.undo
            controller.field.matr.checkcell(1, 0) shouldBe(None)
        }
        "be able to select Cells and notfiying the Observers" in {
            ...
            controller.field.point.get.x should be(0)
            controller.undo
            controller.field.point shouldBe(None)
        }
    }
}